  ...
  return (
    <div className="space-y-10">
      ...
      <motion.div 
        ...
        className="inline-block bg-white border-[1.5px] border-black px-6 py-2 rounded-2xl shadow-[3px_3px_0px_0px_#60A5FA] -rotate-1 cursor-default"
      >
      ...
      <div className="space-y-8">
        {EXPERIENCES_DATA.map((exp, idx) => (
          ...
          >
            ...
            <div className="flex flex-wrap items-start justify-between gap-4 border-b border-black pb-4">
              <div className="space-y-1.5">
                <div className="flex flex-wrap items-center gap-2">
                  <span className={`px-2.5 py-0.5 text-xs font-black text-white border border-black rounded-md ${exp.tagBg} shadow-[1px_1px_0px_0px_#000]`}>
                    {exp.type}
                  </span>
              ...
              <div className="flex items-center gap-2 text-xs font-bold text-black bg-yellow-100 px-3 py-1.5 rounded-xl border border-black shadow-[1.5px_1.5px_0px_0px_#000]">
            ...
            {/* Description */}
            <p className="text-sm sm:text-base font-semibold text-gray-800 bg-gray-50 p-4 border border-black rounded-2xl">
              {exp.description}
            </p>
            ...
            {exp.metrics && (
              <motion.div 
                ...
                className="bg-[#D1FAE5] border border-black p-3.5 rounded-xl font-bold text-black text-xs sm:text-sm flex items-center justify-between"
              >
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-dashed border-gray-200">
